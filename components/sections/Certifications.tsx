      ...
      <div className="grid items-stretch gap-4 md:grid-cols-3">
        {certifications.map((certification) => (
          <Card key={certification.name} className="flex h-full min-h-[230px] flex-col p-6">
            ...
            <p className="text-sm text-subdued">{certification.issuer}</p>
            <h3 className="mt-2 min-h-[56px] text-lg font-semibold leading-7 text-foreground">
              {certification.name}
            </h3>
            <div className="mt-4 min-h-[28px]">
              <p className="inline-flex rounded-full border border-line bg-ink/25 px-3 py-1 text-xs text-muted">
